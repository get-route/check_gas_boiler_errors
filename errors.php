...
<head>
    ...
    <meta name="description" content="<?php echo "Код ошибки котла ".$kontent_errors['titlecat_error']. ". Как расшифровать и устранить ".$kontent_errors['code_error'].". Советы, чтобы неисправность больше не беспокоила"?>">
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Slab&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/css/style.css">
    <link rel="stylesheet" href="/css/bootstrap.min.css">
    <link rel="icon" href="/favicon.png" type="image/png">
    <link rel="stylesheet" type="text/css" href="/css/jquery.fancybox.min.css">
    <title><?php echo "Котел ".$kontent_errors['titlecat_error']." ошибка ".$kontent_errors['code_error']." - расшифровка, как устранить"?></title>
<!-- Yandex.RTB -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center h1-brands">
                <h1>Ошибкa <?php echo $kontent_errors['code_error']." газового котла ".$kontent_errors['titlecat_error']?></h1>
            </div>
            <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 ">
                ...
                <table class="errors-table table table-bordered table-striped table-Secondary table-responsive">
                    ...
                    <tr>
                        <td>Русский:</td>
                        <td>"Что означает неисправность -  <?php  echo $kontent_errors['code_error'].". ". $kontent_errors['rus_error'] ?>"</td>
                    </tr>
                    <tr>
                        <td>Английский:</td>
    ...
    <div class="container">
        <div class="row">
            <div class="text-center col-lg-12">
                <hr class="hr-info">
                <img src="/images/config/gazboiler.webp" class="brands-image-hr">
            </div>
            <h2 id="reset" class="col-lg-12 text-center">Как устранить <?php echo $kontent_errors['code_error'] ?>?</h2>
            <div class="col-lg-12 text-center">
                <?php
                //Рекламный блок.
