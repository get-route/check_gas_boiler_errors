                ...
                <nav class="navbar navbar-expand-lg navbar-light ">
                   <?php if ($_SERVER['REQUEST_URI']!=="/"){ ?>
                    <a class="navbar-brand" href="<?php echo INDEX ?>">
                           <img src="/images/config/logo.webp" alt="Коды ошибок газовых котлов онлайн" width="100" height="100">₭otel-Ērror.ru</a><?php  } else {?>
                       <p class="navbar-brand" href="">
                           <img src="/images/config/logo.webp" alt="Коды ошибок газовых котлов онлайн" width="100" height="100">₭otel-Ērror.ru</p>
                   <?php } ?>
...
<div class="col-lg-12">
    <div class="row">
        ...
        <div class="col-lg-4 text-center">
            <h4>Наши соц.сети:</h4>
            <noindex><a target="_blank" href="https://vk.com/kotelerrors"><img src="/images/config/vk-footer.webp" width="100" height="100"></a>
            </noindex>
        </div>
        <div class="col-lg-4 text-center">
